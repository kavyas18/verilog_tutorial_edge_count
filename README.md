...
## Instructions
0. Get on the caddy systems - `ssh -Y <SUNetID>@caddy.stanford.edu`, cd into your afs-home directory, `cd afs-home`, clone this repo: `git clone https://github.com/kavyas18/verilog_tutorial_edge_count.git`, then activate tcsh :`tcsh`
